...
import { getUserInfo, updateUserInfo, updatePassword } from "../api/requests";
    ...
    <div className="relative min-h-screen">
      ...
      <main className="mx-auto max-w-xl px-4 py-10">
        <div className="rounded-2xl bg-white shadow-2xl ring-1 ring-black/5">
          {/* Tabs */}
          <div className="flex gap-1 rounded-t-2xl bg-gray-50 p-1.5">
                ...
                {infoLoading ? (
                  ...
                  <form onSubmit={handleInfoSubmit} className="space-y-4">
                    ...
                    <button
                      type="submit"
                      disabled={infoSaving}
                      className="group relative w-full overflow-hidden rounded-xl bg-red-700 py-3 text-sm font-bold text-white transition-all hover:bg-red-800 disabled:opacity-60"
                    >
                      ...
                      <span className="relative">
                        {infoSaving ? "Сохранение…" : "Сохранить изменения"}
                      </span>
                    </button>
                  </form>
                )}
